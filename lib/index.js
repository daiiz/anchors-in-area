    ...
    value: function find(range) {
      ...
      try {
        for (var _iterator3 = candidateAnchorNodes[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          ...
          var rectLeft = rect.left + this.px(anchorNode, 'padding-left');
          var rectRight = rect.right - this.px(anchorNode, 'padding-right');
          var rectTop = rect.top + this.px(anchorNode, 'padding-top');
          var rectBottom = rect.bottom - this.px(anchorNode, 'padding-bottom');
